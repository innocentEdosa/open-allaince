  ...
  return (
    <>
      ...
      <form
        ...
        className="border-t xs:mt-5 xs:pt-5 lg:pt-10 border-shade-placeholder border-opacity-70 lg:px-6 join_form"
      >
        {formStep === 1 && (
          <>
          ...
          <>
            ...
            <div className="mt-8 h-56 ">
              <PrimaryButton disabled={registering} type="submit">
                {!registering && <h6 className="text-26 font-sans font-semibold tracking-open">
                  Join
                </h6>}
                {
